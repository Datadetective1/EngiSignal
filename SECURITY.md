...
- The worker holds no storage credential. The request that accepts an upload, already authenticated as the file's owner, mints a signed URL scoped to that single object.
